...
void inicio_LCD(void){
    TRISD = 0x00;
    LCD_CONFIG();
    _delay((unsigned long)((17)*(8000000UL/4000.0)));
    BORRAR_LCD();
    CURSOR_HOME();
    CURSOR_ONOFF(1);
}
...
void main(void) {
    ...
    while(1){
        switch(indicador){
            ...
            case 2:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((1500)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((18500)*(8000000UL/4000000.0)));
                break;
            case 3:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((1900)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((18100)*(8000000UL/4000000.0)));
                break;
            case 4:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((2300)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((17700)*(8000000UL/4000000.0)));
                break;
        }
    }
}
...
void __attribute__((picinterrupt(("high_priority")))) INT0_ISR(void){
    ...
    _delay((unsigned long)((99)*(8000000UL/4000.0)));
}
