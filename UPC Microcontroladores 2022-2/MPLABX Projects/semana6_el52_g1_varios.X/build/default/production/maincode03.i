...
sigue1: DB 6DH,06H,77H,5EH,3FH,00H,7CH,50H,06H,54H,54H,3FH
...
configuro:
    ...
    movlw 0A0H
    movwf INTCON ;((INTCON) and 0FFh), 7, a=1, ((INTCON) and 0FFh), 5, a=1 (TMR0 interrupt enabled)
    clrf TBLPTRU
    clrf cuenta
...
high_priority_ISR:
    bcf INTCON, 2 ;((INTCON) and 0FFh), 2, a=0
    movlw 0BH
    movwf TMR0H
    movlw 0DCH
