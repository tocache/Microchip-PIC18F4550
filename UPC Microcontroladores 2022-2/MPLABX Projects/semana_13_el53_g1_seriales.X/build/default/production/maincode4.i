...
unsigned char led_on[]={0x04,0x1F,0x1F,
                        0x0E,0x04,0x1F,
                        0x04,0x04};
unsigned char bienvenida[]={"Primer mensaje"};
unsigned char mensajon[]={"Oye presionaste el INT2"};
...
void main(void) {
    ...
    unsigned char camote;
    for(camote=0;camote<14;camote++){
        TXREG = bienvenida[camote];
