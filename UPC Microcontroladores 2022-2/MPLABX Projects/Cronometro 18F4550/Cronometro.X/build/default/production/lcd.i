...
void Lcd_Send_Nibble(unsigned char nibble)
{
    if((nibble & 1)==1) LATDbits.LD4 = 1; else LATDbits.LD4 = 0;
    if((nibble & 2)==2) LATDbits.LD5 = 1; else LATDbits.LD5 = 0;
    if((nibble & 4)==4) LATDbits.LD6 = 1; else LATDbits.LD6 = 0;
    if((nibble & 8)==8) LATDbits.LD7 = 1; else LATDbits.LD7 = 0;
