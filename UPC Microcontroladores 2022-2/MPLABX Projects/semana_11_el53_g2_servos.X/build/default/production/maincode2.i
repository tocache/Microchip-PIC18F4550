...
void inicio_LCD(void){
    TRISD = 0x00;
    LCD_CONFIG();
    _delay((unsigned long)((22)*(8000000UL/4000.0)));
    BORRAR_LCD();
    CURSOR_HOME();
    CURSOR_ONOFF(1);
}
...
void main(void) {
    ...
    while(1){
        switch(posicion){
            case 0:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((600)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((19400)*(8000000UL/4000000.0)));
                break;
            case 1:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((800)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((19200)*(8000000UL/4000000.0)));
                break;
            case 2:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((1000)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((19000)*(8000000UL/4000000.0)));
                break;
            case 3:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((1200)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((18800)*(8000000UL/4000000.0)));
                break;
            case 4:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((1400)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((18600)*(8000000UL/4000000.0)));
                break;
            case 5:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((1600)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((18400)*(8000000UL/4000000.0)));
                break;
            case 6:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((1800)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((18200)*(8000000UL/4000000.0)));
                break;
            case 7:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((2000)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((18000)*(8000000UL/4000000.0)));
                break;
            case 8:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((2200)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((17800)*(8000000UL/4000000.0)));
                break;
            case 9:
                LATEbits.LE0 = 1;
                _delay((unsigned long)((2400)*(8000000UL/4000000.0)));
                LATEbits.LE0 = 0;
                _delay((unsigned long)((17600)*(8000000UL/4000000.0)));
                break;
        }
    }
}
