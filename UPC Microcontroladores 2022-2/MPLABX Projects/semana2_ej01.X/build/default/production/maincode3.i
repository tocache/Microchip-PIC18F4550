...
configuro:
    movlw 00H ;Configurar todo el ((EECON1) and 0FFh), 0, a como salida
    movwf TRISD
loop:
    ...
    movlw 99H ;Cuando es verdad, escribe 0AAH en ((EECON1) and 0FFh), 0, a
    movwf LATD
    goto loop
no_es_cero:
    movlw 66H ;Escribe 55H en ((EECON1) and 0FFh), 0, a
    movwf LATD
    goto loop
    end programa
