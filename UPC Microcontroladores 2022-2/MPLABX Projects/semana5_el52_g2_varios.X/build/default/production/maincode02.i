...
configuro:
    ...
    movlw 0A0H
    movwf INTCON ;((INTCON) and 0FFh), 7, a=1, ((INTCON) and 0FFh), 5, a=1. Activamos int para Timer0

inicio:
    movlw 77H
    movwf LATD ;mando A a ((EECON1) and 0FFh), 0, a
    bsf LATB, 0 ;enciendo primer digito
    call nopx8 ;espero un ratito
    bcf LATB, 0 ;apago del primer digito
    movlw 5BH
    movwf LATD ;mando Z a ((EECON1) and 0FFh), 0, a
    bsf LATB, 1 ;enciendo segundo digito
    call nopx8 ;espero un ratito
    bcf LATB, 1 ;apago del segundo digito
    movlw 3EH
    movwf LATD ;mando U a ((EECON1) and 0FFh), 0, a
    bsf LATB, 2 ;enciendo tercer digito
    call nopx8 ;espero un ratito
    bcf LATB, 2 ;apago del tercer digito
    movlw 38H
    movwf LATD ;mando L a ((EECON1) and 0FFh), 0, a
