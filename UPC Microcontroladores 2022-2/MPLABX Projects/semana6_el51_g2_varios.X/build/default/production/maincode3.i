...
# 725 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\pic18_chip_select.inc" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\proc\\pic18f4550.inc" 1 3
# 48 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\proc\\pic18f4550.inc" 3
SPPDATA equ 0F62h
...
TOSU equ 0FFFh
# 6182 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\proc\\pic18f4550.inc" 3
...
# 725 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\pic18_chip_select.inc" 2 3
...
ind1 EQU 001H ;establece basculacion de ((PORTB) and 0FFh), 0, a
ind2 EQU 002H
...
configuro:
    movlw 80H
    movwf TRISD ;((EECON1) and 0FFh), 0, a(6:0) como salidas
    movlw 0E1H
    movwf TRISB
    clrf LATB
    movlw 81H
 ...
 bsf RCON, 7
 movlw 0F0H
 movwf INTCON ;((INTCON) and 0FFh), 7, a=1, ((INTCON) and 0FFh), 6, a=1, ((INTCON) and 0FFh), 5, a=1, ((INTCON) and 0FFh), 4, a=1 activando interrupciones
 bcf INTCON2, 2 ;((INTCON2) and 0FFh), 2, a = 0 para que TMR0 este en low priority
 bcf INTCON2, 7 ;resistencias internas de pullup en rb activadas
 bcf INTCON2, 6 ;((INTCON2) and 0FFh), 6, a = 0 para falling edge de ((PORTB) and 0FFh), 0, a
    ;termino de zona
    clrf TBLPTRU
...
Int0_ISR:
    bcf INTCON, 1 ;bajamos bandera ((INTCON) and 0FFh), 1, a
    btfss ind1, 0
    goto es_cero
es_uno:
    movlw 2
...
Tmr0_ISR:
    bcf INTCON, 2 ;Bajamos bandera ((INTCON) and 0FFh), 2, a
    movlw 0BH
    movwf TMR0H
    movlw 0DCH
