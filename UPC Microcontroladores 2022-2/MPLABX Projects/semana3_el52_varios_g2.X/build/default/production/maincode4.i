...
oyuquito:
    ...
    ORG 000020H
configuro:
    bcf INTCON2, 7 ;((INTCON2) and 0FFh), 7, a activadas
    movlw 80H
    movwf TRISD ;((EECON1) and 0FFh), 0, a(6:0) como salidas
inicio:
    btfsc PORTB, 0 ;Pregunto si presione boton en ((PORTB) and 0FFh), 0, a
    goto no_machuque_RB0
    movlw 3EH
    movwf LATD
    goto inicio
no_machuque_RB0:
    btfsc PORTB, 1 ;Pregunto si presione boton en ((PORTB) and 0FFh), 1, a
    goto no_machuque_RB1
    movlw 73H
    movwf LATD
    goto inicio
no_machuque_RB1:
    btfsc PORTB, 2 ;Pregunto si presione boton en ((PORTB) and 0FFh), 1, a
