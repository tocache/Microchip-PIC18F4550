...
configuro:
    ...
    bcf TRISB, 0 ;((PORTB) and 0FFh), 0, a como salida
    movlw 0C0H
    movwf T0CON ;Timer0 ON, fosc/4, psc 1:2, 8bit
inicio:
    bsf LATB, 0 ;((PORTB) and 0FFh), 0, a en uno
otro:
    movlw 6
...
otro2:
    ...
    bcf INTCON, 2 ;verdad, bajamos bandera ((INTCON) and 0FFh), 2, a
    btg LATC, 0 ;basculo salida ((PORTC) and 0FFh), 0, a
    goto otro
    end chocolate
