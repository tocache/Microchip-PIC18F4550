...
configuro:
    movlw 0F0H
    movwf TRISD ;Puertos ((PORTD) and 0FFh), 3, a-((PORTD) and 0FFh), 0, a como salidas
...
; movwf temporal
    ...
    movlw 09H ;verdad, manda 09H a ((EECON1) and 0FFh), 0, a
    movwf LATD
    goto loop ;regreso al inicio
no_es_cero:
    movlw 06H ;manda 06H a ((EECON1) and 0FFh), 0, a
    movwf LATD
    goto loop ;regreso al inicio
