...
configuro:
    bsf TRISB, 0 ;puerto ((PORTB) and 0FFh), 0, a como entrada
    bcf TRISD, 0 ;puerto ((PORTD) and 0FFh), 0, a como salida
lazo:
    btfss PORTB, 0 ;pregunto si ((PORTB) and 0FFh), 0, a es uno
    goto falso ;cuando es falso, salta a etiqueta falso
    bcf LATD, 0 ;cuando es verdad, pone ((PORTD) and 0FFh), 0, a a cero
    goto lazo ;salto a etiqueta lazo
falso:
    bsf LATD, 0 ;pone ((PORTD) and 0FFh), 0, a a uno
    goto lazo ;salto a etiqueta lazo
