...
configuro:
    ...
    movlw 0F0H
    movwf INTCON ;Interrupciones habilitadas para Timer0 y para ((PORTB) and 0FFh), 0, a
    bcf INTCON2, 7 ;Activar las weak pull up del RB
    bcf INTCON2, 6 ;falling edge para ((PORTB) and 0FFh), 0, a
...
Tmr0_ISR:
    bcf INTCON, 2 ;Bajamos la bandera ((INTCON) and 0FFh), 2, a
    movlw 0BH
    movwf TMR0H
    movlw 0DCH
...
Int0_ISR:
    bcf INTCON, 1 ;bajamos la bandera ((INTCON) and 0FFh), 1, a
