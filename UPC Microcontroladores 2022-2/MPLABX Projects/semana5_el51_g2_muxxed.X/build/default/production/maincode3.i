...
configuro:
    movlw 80H
    movwf TRISD ;((EECON1) and 0FFh), 0, a(6:0) como salidas (segmentos)
    movlw 0F0H
    ...
    movlw HIGH mensaje
    movwf TBLPTRH
    bcf INTCON2, 7 ;activando ((INTCON2) and 0FFh), 7, a
inicio:
    movlw LOW mensaje
    movwf TBLPTRL
    btfsc PORTB, 4 ;pregunto si presione el boton en ((PORTB) and 0FFh), 4, a
