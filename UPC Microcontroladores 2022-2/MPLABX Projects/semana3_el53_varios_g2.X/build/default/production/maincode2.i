...
inicio:
    btfsc PORTB, 1 ;pregunto si machuque el boton ((PORTB) and 0FFh), 1, a
    goto inicio ;falso, vuelve a preguntar
    btg LATC, 0 ;verdad, basculo ((PORTC) and 0FFh), 0, a
otro:
    btfss PORTB, 1 ;pregunto si soltaste el boton ((PORTB) and 0FFh), 1, a
    goto otro
    goto inicio
    end ciruela
