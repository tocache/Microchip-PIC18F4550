...
inicio:
    btfsc PORTB, 3 ;Pregunto si ((PORTB) and 0FFh), 3, a es cero
    goto no_machuque_RB3 ;Falso, salta a etiqueta indicada
    bcf LATC, 0 ;Verdad, apago el LED en ((PORTC) and 0FFh), 0, a
    goto inicio ;retorno a inicio
no_machuque_RB3:
    btfsc PORTB, 2 ;Pregunto si ((PORTB) and 0FFh), 2, a es cero
    goto inicio ;Falso, retorna a inicio
    bsf LATC, 0 ;Verdad, enciendo LED en ((PORTC) and 0FFh), 0, a
    goto inicio
    end ciruela
