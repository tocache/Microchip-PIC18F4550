...
void arranque_LCD(void){
    TRISD = 0x00;
    LCD_CONFIG();
    _delay((unsigned long)((17)*(32000000UL/4000.0)));
    BORRAR_LCD();
    CURSOR_HOME();
    CURSOR_ONOFF(1);
}
...
void __attribute__((picinterrupt(("high_priority")))) CCP1_ISR(void){
    PIR1bits.CCP1IF = 0;
    if(ticks == 15){
        ticks = 0;
        if(segundos == 59){
...
void __attribute__((picinterrupt(("low_priority")))) INT12_ISR(void){
