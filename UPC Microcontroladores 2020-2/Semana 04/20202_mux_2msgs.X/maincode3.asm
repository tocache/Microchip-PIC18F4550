...
init_conf:
    ...
    movlw 0x06
    movwf TBLPTRH	;La parte HIGH de TBLPTR tendra el valor de 0x06
    movlw 0x83
    movwf T0CON		;TMR0 ON, FOSC/4, 16BIT, 1:16 PSC
    clrf MENSAJE
loop:
    btfss INTCON, TMR0IF	;PRegunto si se desbordo el TMR0
    goto falso
verdad:
    btg MENSAJE, 0
...
multiplex:    
    TBLRD*+		;Lee el contenido apuntado y luego incrementa el valor de la dirección del TBLPTR
