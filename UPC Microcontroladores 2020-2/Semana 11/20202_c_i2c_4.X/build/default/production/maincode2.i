...
unsigned char button3_stat = 0;
unsigned char frase[] = {"KeepCalm UPC"};
...
void main(void){
    ...
    while(1){
        ...
        if (PORTBbits.RB3 == 1 && button3_stat == 0){

            pcf8574_write(0x55);
            POS_CURSOR(2,0);
            ESCRIBE_MENSAJE("Dato PCF8574",12);
            button3_stat = 1;
        }
        else if(PORTBbits.RB3 == 0 && button3_stat == 1){
            button3_stat = 0;
            pcf8574_write(0xAA);
            POS_CURSOR(2,0);
            ESCRIBE_MENSAJE("            ",12);
