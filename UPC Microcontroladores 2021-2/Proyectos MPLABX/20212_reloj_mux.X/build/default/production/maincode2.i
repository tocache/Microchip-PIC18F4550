...
configuro:
    movlw 80H
    movwf TRISD ;((PORTD) and 0FFh), 6, a-((PORTD) and 0FFh), 0, a como salidas
    movlw 0F0H
    movwf TRISB ;((PORTB) and 0FFh), 3, a-((PORTB) and 0FFh), 0, a como salidas
...
; movlw 07H
; movwf T1CON ;Tmr1 ON, PSC 1:1, ((PORTC) and 0FFh), 0, a (((T1CON) and 0FFh), 3, a=0) sin cristal para Proteus
    movlw 0FH
    movwf T1CON ;Tmr1 ON, PSC 1:1, XTAL32K (((T1CON) and 0FFh), 3, a=1) con cristal 32K
; movlw 01H
; movwf PIE1 ;((PIE1) and 0FFh), 0, a=1
    bsf PIE1, 0
; movlw 0C0H
; movwf INTCON ;((INTCON) and 0FFh), 7, a=1,((INTCON) and 0FFh), 6, a=1
    bsf INTCON, 6
    bsf INTCON, 7
