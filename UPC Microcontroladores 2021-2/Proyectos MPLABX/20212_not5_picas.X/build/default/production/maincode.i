...
resetVec:
    ...
    PSECT code
configuro:
     bsf TRISB, 1 ;((PORTB) and 0FFh), 1, a es entrada
     bcf TRISD, 1 ;((PORTD) and 0FFh), 1, a es salida
inicio: btfss PORTB, 1 ;PRegunto ((PORTB) and 0FFh), 1, a=1
     goto falso ;Cuando es falso, salta a label falso
     bcf LATD, 1 ;((PORTD) and 0FFh), 1, a=0
     goto inicio ;Salta a label inicio
falso: bsf LATD, 1 ;((PORTD) and 0FFh), 1, a=1
     goto inicio ;Salta a label inicio
