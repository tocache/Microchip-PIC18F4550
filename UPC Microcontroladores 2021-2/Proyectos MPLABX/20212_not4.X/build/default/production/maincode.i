...
resetVect:
    ...
    PSECT code
configuro:
    bsf TRISB, 2, 0 ;((PORTB) and 0FFh), 2, a como entrada
    bcf TRISD, 2, 0 ;((PORTD) and 0FFh), 2, a como salida
inicio:
    btfss PORTB, 2, 0 ;Pregunto si ((PORTB) and 0FFh), 2, a=1
    goto falso ;Viene aqui cuando falso, salta a label falso
    bcf LATD, 2, 0 ;Viene aqui cuando verdad, ((PORTD) and 0FFh), 2, a=0
    goto inicio ;Salta a label inicio
falso:
    bsf LATD, 2, 0 ;((PORTD) and 0FFh), 1, a=1
    goto inicio ;Salta a label inicio
