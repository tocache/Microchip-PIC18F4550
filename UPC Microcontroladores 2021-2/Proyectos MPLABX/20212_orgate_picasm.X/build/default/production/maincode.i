...
; CONFIG ((RCON) and 0FFh), 0, a = ; Brown-out Reset Enable bits (Brown-out Reset disabled in hardware and software)
; CONFIG BORV = 3 ; Brown-out Reset Voltage bits (Minimum setting 2.05V)
; CONFIG VREGEN = OFF ; USB Voltage Regulator Enable bit (USB voltage regulator disabled)

  CONFIG CONFIG2L = 0x19
...
configuro:
     bsf TRISB, 0, 0 ;((PORTB) and 0FFh), 0, a como entrada
     bsf TRISB, 4, 0 ;((PORTB) and 0FFh), 4, a como entrada
     bcf TRISD, 0, 0 ;((PORTD) and 0FFh), 0, a como salida
inicio:
     btfsc PORTB, 0, 0 ;Pregunto si ((PORTB) and 0FFh), 0, a es cero
     goto falso ;Falso, salta a label falso
     btfsc PORTB, 4, 0 ;Verdadero. Pregunto si ((PORTB) and 0FFh), 4, a es cero
     goto falso ;Falso, salta a label falso
     bcf LATD, 0, 0 ;Verdadero. ((PORTD) and 0FFh), 0, a a 0
     goto inicio ;Retorna a inicio
falso: bsf LATD, 0, 0 ;((PORTD) and 0FFh), 0, a a 1
     goto inicio ;Retorna a inicio
