...
# 3 "maincode.s" 2
    ...
    org 0020H
configuro:
     bcf TRISD, 0 ;Pin ((PORTD) and 0FFh), 0, a como salida
inicio:
     btfsc PORTB, 0 ;Pregunto ((PORTB) and 0FFh), 0, a=0
     goto falso1
     btfsc PORTB, 1 ;Pregunto si ((PORTB) and 0FFh), 1, a=0
     goto falso2
     bcf LATD, 0 ;((PORTB) and 0FFh), 0, a=0, ((PORTB) and 0FFh), 1, a=0, salida ((PORTD) and 0FFh), 0, a=0
     goto inicio
falso1: btfsc PORTB, 1
     goto falso3
     bsf LATD, 0 ;((PORTB) and 0FFh), 0, a=1, ((PORTB) and 0FFh), 1, a=0, salida ((PORTD) and 0FFh), 0, a=1
     goto inicio
falso2: bsf LATD, 0 ;((PORTB) and 0FFh), 0, a=0, ((PORTB) and 0FFh), 1, a=1, salida ((PORTD) and 0FFh), 0, a=1
     goto inicio
falso3:
     bcf LATD, 0 ;((PORTB) and 0FFh), 0, a=1, ((PORTB) and 0FFh), 1, a=1, salida ((PORTD) and 0FFh), 0, a=0
     goto inicio
     end
