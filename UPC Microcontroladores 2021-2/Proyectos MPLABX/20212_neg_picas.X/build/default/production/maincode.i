...
configuro:
     bsf TRISB, 0, 0 ;Puerto ((PORTB) and 0FFh), 0, a como entrada
     bcf TRISD, 0, 0 ;Puerto ((PORTD) and 0FFh), 0, a como salida
inicio:
     btfss PORTB, 0, 0 ;Pregunto si ((PORTB) and 0FFh), 0, a es uno
     goto falso ;Viene aqui cuando es falso
     bcf LATD, 0, 0 ;Viene aqui cuando es verdadero. Mando ((PORTD) and 0FFh), 0, a a cero
     goto inicio ;Salto a inicio
falso: bsf LATD, 0, 0 ;Mando ((PORTD) and 0FFh), 0, a a uno
     goto inicio ;Salto a inicio
