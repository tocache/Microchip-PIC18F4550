...
void main(void) {
    ...
    while(1){
        ...
        for(x=0;x<7;x++){
            LATBbits.LB5 = 1;
            _delay((unsigned long)((1700)*(48000000UL/4000000.0)));
            LATBbits.LB5 = 0;
            _delay((unsigned long)((18300)*(48000000UL/4000000.0)));
        }
        for(x=0;x<7;x++){
            LATBbits.LB4 = 1;
            _delay((unsigned long)((1700)*(48000000UL/4000000.0)));
        ...
        for(x=0;x<7;x++){
            LATBbits.LB5 = 1;
            _delay((unsigned long)((2200)*(48000000UL/4000000.0)));
            LATBbits.LB5 = 0;
            _delay((unsigned long)((17800)*(48000000UL/4000000.0)));
        }
        for(x=0;x<7;x++){
            LATBbits.LB4 = 1;
            _delay((unsigned long)((2200)*(48000000UL/4000000.0)));
