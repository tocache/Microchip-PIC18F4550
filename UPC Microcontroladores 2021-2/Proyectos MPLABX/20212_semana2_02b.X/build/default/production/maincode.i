...
; CONFIG1H
  ...
  CONFIG CONFIG2L = 18H ;Bug reportado, no funciona el detalle del bit de configuración ((RCON) and 0FFh), 0, a
...
muynuevo:
    ...
    ORG 0020H
configuro:
     bcf TRISD, 0, 0 ;((PORTD) and 0FFh), 0, a como salida

inicio: btfsc PORTB, 0, 0 ;Pregunto ((PORTB) and 0FFh), 0, a=0
     goto falso1 ;Salto a falso1 cuando es falso
     btfsc PORTB, 1, 0 ;Pregunto ((PORTB) and 0FFh), 1, a=0
     goto falso2 ;Salto a falso2 cuando es falso
     bcf LATD, 0, 0 ;((PORTB) and 0FFh), 0, a=0 ((PORTB) and 0FFh), 1, a=0 por tanto ((PORTD) and 0FFh), 0, a=0
     goto inicio ;Salto a inicio
falso1: btfsc PORTB, 1, 0 ;Pregunto ((PORTB) and 0FFh), 1, a=0
     goto falso3 ;Salto a falso3 cuando es falso
     bsf LATD, 0, 0 ;((PORTB) and 0FFh), 0, a=1 ((PORTB) and 0FFh), 1, a=0 por tanto ((PORTD) and 0FFh), 0, a=1
     goto inicio ;Salto a inicio
falso2: bsf LATD, 0, 0 ;((PORTB) and 0FFh), 0, a=0 ((PORTB) and 0FFh), 1, a=1 por tanto ((PORTD) and 0FFh), 0, a=1
     goto inicio ;Salto a inicio
falso3: bcf LATD, 0, 0 ;((PORTB) and 0FFh), 0, a=1 ((PORTB) and 0FFh), 1, a=1 por tanto ((PORTD) and 0FFh), 0, a=0
     goto inicio ;Salto a inicio
