...
void main(void) {
    ...
    while(1){
        ...
        if(PORTBbits.RB1 == 0 & PORTBbits.RB0 == 0){
            ...
            LATEbits.LE0 = 0;
            _delay((unsigned long)((19)*(48000000UL/4000.0)));
        }
        else if(PORTBbits.RB1 == 0 & PORTBbits.RB0 == 1){
            ESCRIBE_MENSAJE("Servo: 090",10);
            ENVIA_CHAR(0xDF);
            LATEbits.LE0 = 1;
            _delay((unsigned long)((1500)*(48000000UL/4000000.0)));
            LATEbits.LE0 = 0;
            _delay((unsigned long)((18)*(48000000UL/4000.0)));
            _delay((unsigned long)((500)*(48000000UL/4000000.0)));
        }
            ...
            LATEbits.LE0 = 0;
            _delay((unsigned long)((18)*(48000000UL/4000.0)));
            _delay((unsigned long)((750)*(48000000UL/4000000.0)));
        }
    }
}
