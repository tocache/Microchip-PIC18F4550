...
configuro:
    clrf TRISD			;Todo el puerto D como salida (Sensor LM35)
    clrf TRISB			;Todo el puerto B como salida (Potenciometro limite
...
inicio:
    bsf ADCON1, VCFG0	;Vref pasado a Vref+
    bcf ADCON0, 5
    bcf ADCON0, 4
    bcf ADCON0, 3
    bcf ADCON0, 2   ;Seleccionar Canal AN0 para leer    
...
;    movff ADRESH, LATD	;para 8 bits
lectpot:    
    bcf ADCON1, VCFG0	;Vref pasado a Vdd
    bcf ADCON0, 5
    bcf ADCON0, 4
    bcf ADCON0, 3
    bsf ADCON0, 2   ;Seleccionar Canal AN1 para leer        
    bsf ADCON0, 1   ;Inicio la conversion
aunno2:
    btfsc ADCON0, 1 ;Pregunto si ya termino de convertir
    goto aunno2	    ;Aun esta convirtiendo
    movff ADRESH, LATB	;para 8 bits
    goto inicio
    end