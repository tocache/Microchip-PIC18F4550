...
mensaje db 0x76, 0x3F, 0x38, 0x77	;mensaje a visualizar en el display
    org 0x0300
mensaje2 db 0x00, 0x3E, 0x73, 0x39	;mensaje UPC
    org 0x0400
mensaje3 db 0x06, 0x54, 0x6F, 0x79	;mensaje INGE
    org 0x0500
mensaje4 db 0x54, 0x06, 0x79, 0x50	;mensaje NIER
    org 0x0600
mensaje5 db 0x06, 0x77, 0x00, 0x00	;mensaje IA
    org 0x0700
mensaje6 db 0x37, 0x79, 0x39, 0x77	;mensaje MECA
    org 0x0800
mensaje7 db 0x78, 0x50, 0x5C, 0x54	;mensaje TRON
    org 0x0900
mensaje8 db 0x06, 0x39, 0x77, 0x00	;mensaje ICA    
