;Este es un comentario, se le antecede un punto y coma
    ...
    org 0x0500
mensaje_1 db 0x79, 0x38, 0x38, 0x77	;ELLA
 
    org 0x0600
mensaje_2 db 0x00, 0x54, 0x5c, 0x00    ;no
    
    org 0x0700
mensaje_3 db 0x00, 0x00, 0x78, 0x79    ;te

    org 0x0800
mensaje_4 db 0x00, 0x77, 0x37, 0x77    ;AMA
...
loop:	    movlw HIGH mensaje_1
	    ...
	    movwf TBLPTRH
	    call delay_long
	    movlw HIGH mensaje_3
	    movwf TBLPTRH
	    call delay_long
	    movlw HIGH mensaje_4
	    movwf TBLPTRH
	    call delay_long
	    goto loop
