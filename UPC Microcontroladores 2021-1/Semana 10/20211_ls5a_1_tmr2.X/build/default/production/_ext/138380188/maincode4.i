# 1 "../20211_el53_1_ints.X/maincode4.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../20211_el53_1_ints.X/maincode4.c" 2
...
# 1 "../20211_el53_1_ints.X/cabecera.h" 1
...
# 2 "../20211_el53_1_ints.X/maincode4.c" 2

# 1 "../20211_el53_1_ints.X/LCD.h" 1
...
# 3 "../20211_el53_1_ints.X/maincode4.c" 2
...
void main(void) {
    ...
    while(1){
        ...
        ESCRIBE_MENSAJE (" f:",3);
        frecuencia = 1639.83-(promedio*3.878);
        convierte(frecuencia);
        ENVIA_CHAR(millar+0x30);
        ENVIA_CHAR(centena+0x30);
        ENVIA_CHAR(decena+0x30);
        ENVIA_CHAR(unidad+0x30);
        ESCRIBE_MENSAJE ("Hz",2);
    }
}

void __attribute__((picinterrupt(("")))) TMR2_ISR(){
