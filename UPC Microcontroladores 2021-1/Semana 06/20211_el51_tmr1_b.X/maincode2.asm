...
loop:	    movff dec_min, TBLPTRL  ;llamada a tabla para sacar decena
	    TBLRD*
	    ...
	    movff uni_min, TBLPTRL  ;llamada a tabla para sacar decena
	    TBLRD*
	    movff TABLAT, LATD	    ;digito decena decodificado hacia RD
	    bsf LATB, 1		    ;habilitas digito 0 del display
	    call unops		    ;pequeño retardo
	    bcf LATB, 1		    ;deshabilito digito 0 del display
	    movff dec_seg, TBLPTRL  ;llamada a tabla para sacar decena
	    TBLRD*
	    movff TABLAT, LATD	    ;digito decena decodificado hacia RD
	    ...
	    bsf LATB, 3		    ;habilito digito 1 del display
	    call unops		    ;pequeño retardo
