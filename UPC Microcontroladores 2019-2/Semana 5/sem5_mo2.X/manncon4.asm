...
letrasa EQU 0x028
    ...
    org 0x0200
liston db 0x00, 0x00, 0x00, 0x00, 0x6F, 0x5F, 0x7C, 0x6E, 0x00, 0x6E, 0x00, 0x39, 0x3F, 0x73, 0x3F, 0x00, 0x00, 0x00, 0x00, 0x55, 0xAA, 0xEE
    org 0x0300
liston2 db 0x00, 0x00, 0x00, 0x00, 0x39, 0x3F, 0x73, 0x3F, 0x00, 0x00, 0x00, 0x00, 0x55, 0xAA, 0xEE
...
mercado:
    ...
    movlw 0xB0
    movwf INTCON		;Enciendo la interrupcion de TMR0 y de INT0
    bsf INTCON3, INT1IE		;Enciendo la INT1
    clrf letrasa
