...
void main(void) {
    ...
    while(1){
        if (estado == 0){
            ...
            ESCRIBE_MENSAJE("     ", 5);
            LATEbits.LE0 = 1;
            _delay((unsigned long)((500)*(32000000UL/4000000.0)));
            LATEbits.LE0 = 0;
            _delay((unsigned long)((19500)*(32000000UL/4000000.0)));
        }
        else if (estado == 2){
            POS_CURSOR(2, 0);
            ...
            ESCRIBE_MENSAJE("    ", 4);
            LATEbits.LE0 = 1;
            _delay((unsigned long)((1500)*(32000000UL/4000000.0)));
            LATEbits.LE0 = 0;
            _delay((unsigned long)((18500)*(32000000UL/4000000.0)));
            ...
            ESCRIBE_MENSAJE("   ", 3);
            LATEbits.LE0 = 1;
            _delay((unsigned long)((2500)*(32000000UL/4000000.0)));
            LATEbits.LE0 = 0;
            _delay((unsigned long)((17500)*(32000000UL/4000000.0)));
        }
    }
}

void __attribute__((picinterrupt(("")))) IntsISR(void){
