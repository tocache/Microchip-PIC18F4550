...
configuro:
	...
	movlw 0x88
	movwf INTCON		;Habilitamos interrupción por RB47

inicio: nop
	goto inicio
	
interroop:
	movf PORTB, w		;Leyendo el puerto B (evitar el mismatch segun datasheet))
	nop			;Esperando un ciclo adicional
	btfss PORTD, 0
	goto apagao
	bcf LATD, 0
	goto otro
apagao:	bsf LATD, 0
otro:	bcf INTCON, RBIF
        retfie
