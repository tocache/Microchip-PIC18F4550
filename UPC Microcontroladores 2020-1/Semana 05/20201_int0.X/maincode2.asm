...
loop:
    ...
    ;Rutina de interrupción de alta prioridad    
interropt_hp:
	    btg LATD, 7		    ;Complemento de RD7
	    bcf INTCON, INT0IF	    ;Bajamos la bandera de la interrupción externa
	    retfie
	    
    ;Rutina de interrupción de baja prioridad    
interropt_lp:
	    btg LATD, 5		    ;Complemento de RD7
	    bcf INTCON3, INT1IF	    ;Bajamos la bandera de la interrupción externa
	    retfie	    
