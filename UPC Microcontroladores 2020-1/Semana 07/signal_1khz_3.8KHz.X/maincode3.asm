...
;Se implementó la INT1 y se encuentra en baja prioridad.
;Dentro de la rutina de baja prioridad se esta atendiendo primero a Timer0
...
FUE_TMR0:
	...
	btfss PIR1, INT1IF	;PReguntar si se levanto el INT1
	retfie
FUE_INT1:
	btg LATB, 3
	bcf INTCON3, INT1IF
