...
beginning:
    ...
    clrf CONT
    movlw 0x88
    movwf INTCON		;Enable interrupts on RBIE/RBIF
    
loop:
    clrf TBLPTRL
    movf CONT, W		;Read port RB and store to W register
    andlw 0x0F
    addwf TBLPTRL, f
    TBLRD*
    movff TABLAT, LATD
...
interrupta:
    incf CONT, f
    movf PORTB, f		;this instruction and the following instruction 
    nop				;is to prevent mismatch as stated on the datasheet
    bcf INTCON, RBIF
    retfie
