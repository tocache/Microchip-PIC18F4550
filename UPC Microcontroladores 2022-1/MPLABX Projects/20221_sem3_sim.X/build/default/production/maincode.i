...
principal:
    ORG 0100H
numeros: DB 7FH, 0AAH, 5AH, 4EH, 33H
...
configuro:
    ...
    movwf TBLPTRH
    movlw LOW numeros
    movwf TBLPTRL ;TBLPTR apuntando a 000100H

loop:
    ;comf PORTB, 0 ;Leo RB, aplico complemento y lo almaceno en WReg
    movlw 02H
    addwf TBLPTRL, 1
    TBLRD* ;Leo contenido apuntado por TBLPTR
    movf TABLAT, 0 ;Muevo el contenido de TABLAT haci8a WReg
    movwf LATD ;Muevo contenido de WReg hacia LATD
    goto loop
    end principal
