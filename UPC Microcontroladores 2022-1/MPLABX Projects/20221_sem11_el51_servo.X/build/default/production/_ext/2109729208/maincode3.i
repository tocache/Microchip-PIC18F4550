# 1 "../20221_sem11_el53_servo.X/maincode3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../20221_sem11_el53_servo.X/maincode3.c" 2
...
# 1 "../20221_sem11_el53_servo.X/cabecera.h" 1
...
# 2 "../20221_sem11_el53_servo.X/maincode3.c" 2
...
void main(void) {
    ...
    while(1){
        if(PORTBbits.RB0 == 1){
            ...
            LATBbits.LB7 = 0;
            _delay((unsigned long)((20000)*(48000000UL/4000000.0)));
            INTCONbits.TMR0IF = 0;
        }
        else{
            LATBbits.LB7 = 1;
