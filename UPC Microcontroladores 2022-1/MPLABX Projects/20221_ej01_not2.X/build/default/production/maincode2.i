...
configuro: bsf TRISB, 0 ;pin ((PORTB) and 0FFh), 0, a como entrada
     bcf TRISD, 0 ;pin ((PORTD) and 0FFh), 0, a como salida

     bsf TRISB, 6
     bcf TRISD, 6

lazo: btfss PORTB, 0 ;Pregunto si ((PORTB) and 0FFh), 0, a es uno
     goto falso ;Falso, salta a etiqueta falso
     bcf LATD,0 ;Verdadero, pone ((PORTD) and 0FFh), 0, a en cero
     goto siguiente ;Salta a etiqueta lazo (hacer de nuevo)

falso: bsf LATD, 0 ;Pone ((PORTD) and 0FFh), 0, a en uno
