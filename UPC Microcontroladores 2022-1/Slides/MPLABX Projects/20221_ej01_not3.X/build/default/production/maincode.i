...
# 4 "maincode.s" 2
    ...
    PSECT compuerta_not, class=CODE, reloc=2, abs
...
configuro:
    ...
    bsf TRISB, 0 ;Puerto ((PORTB) and 0FFh), 0, a es una entrada
    bcf TRISD, 0 ;puerto ((PORTD) and 0FFh), 0, a sea una salida

lazo: ;Inicio de tu programa
    btfss PORTB, 0 ;Pregunta si ((PORTB) and 0FFh), 0, a es uno
    goto falso ;Falso, salta a etiqueta "falso"
    bcf LATD, 0 ;Verdadero, manda a cero el ((PORTD) and 0FFh), 0, a
    goto lazo ;Retorna a preguntar de nuevo

falso:
    bsf LATD, 0 ;Coloca a uno ((PORTD) and 0FFh), 0, a
    goto lazo ;Retorna a preguntar de nuevo
    end compuerta_not
